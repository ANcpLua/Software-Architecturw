...
- Determine subsystems using **Service Elicitation → Subsystem Establishment**
- Apply **A/T/0 blood type architecture model**
- Design **Application Cores** (small → large)
- Use **requirements embeddings** for clustering
- Perform architecture evaluation with change impact matrices
...
- EarlyBird system requirements

---

## Notes

- Complete **Mars02 before EarlyBird12** — the small application core is the conceptual foundation.
- Embedding-based clustering (ArchDev02) shows AI4SE in practice.
- MateMate02 bridges classical architecture methods and modern AI-based tooling.
